			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="login.php">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100"><?= _email ?></span>
						<input class="input100" type="email" name="email" placeholder="<?= _enteremail ?>" required="required">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100"><?= _password ?></span>
						<input class="input100" type="password" name="password" placeholder="<?= _enterpw ?>">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="backlink" style="display: block;float:left;width: 80%;height: 80%;margin-top: 60px;border-bottom: 1px solid gold;margin-left: -20px;padding-bottom: 20px;">
						<a href="landingpage.php" style="text-align:center;padding-bottom: 20px;"><i class="fa fa-long-arrow-left"></i>&nbsp;&nbsp;&nbsp;<?= _bktofms ?></a>
					</div>
				</form>
