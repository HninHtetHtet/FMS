...
<body>
  	  ...
  	  <div class="signup">
  	  	...
  	  	<form method="post" action="signup.php" enctype="multipart/form-data" id="regiform">	
  	  		<div class="content">
  	  			<div class="inpcon">
	  	  			<div class="labelsg"><?= _name ?>
	  	  				<b style="color:red"> *</b>
	  	  			</div>
					<input type="text" name="name" placeholder="<?= _name ?>" class="boxsg" id="sgkhname">
  	  			</div>

  	  			<div class="inpcon">
	  	  			<div class="labelsg"><?= _email ?><b style="color:red"> *</b></div>
					<input type="email" name="email" placeholder="<?= _email ?>" class="boxsg" id="sgkhemail">
  	  			</div>

  	  			<div class="inpcon">
	  	  			<div class="labelsg"><?= _nrc ?><b style="color:red"> *</b></div>
					<input type="text" name="nrc" placeholder="<?= _nrceg ?>" class="boxsg" id="sgkhnrc">
          <span id="pnrc"></span>
          <span id="pnrc1"></span>
  	  			</div>

  	  			<div class="inpcon">
	  	  			<div class="labelsg"><?= _address ?></div>
					<input type="text" name="address" placeholder="<?= _address ?> (No,Street,Block,Township)" class="boxsg" id="sgkhaddress">
  	  			</div>

  	  			<div class="inpcon">
	  	  			<div class="labelsg"><?= _ph ?><b style="color:red"> *</b></div>
					<input type="telephone" name="phone" placeholder="<?= _ph ?>" class="boxsg" id="sgkhtelephone">
  	  			</div>


  	  			<div class="inpcon">
					<div class="labelsg"><?= _dob ?></div>
					<input type="date" name="dob" class="boxsg" id="dob">
  	  			</div>

  	  			<div class="inpcon">
	  	  			<div class="labelsg"><?= _password ?><b style="color:red"> *</b></div>
					<input type="password" name="password" placeholder="Password" class="boxsg" id="ownerkhpw">
  	  			</div>

  	  			<div class="inpcon">
	  	  			<div class="labelsg"><?= _confirmpw ?><b style="color:red"> *</b></div>
					<input type="password" name="cpassword" placeholder="Confirm Password" class="boxsg" id="ownerkhconfirmpw">
  	  			</div>

  	  			<div class="butsg">  	  
  	  				<a href="landingpage.php" style="margin-left: 10px;border-bottom: 1px solid #20c997;padding-bottom: 10px;"><i class="fa fa-long-arrow-left" style="color: "></i>&nbsp;&nbsp;&nbsp;&nbsp;<?= _bktofms ?></a>				
					<button class="sgthree" style="display: inline-block;margin-left: 20%;outline: none;"><?= _submit ?></button>
