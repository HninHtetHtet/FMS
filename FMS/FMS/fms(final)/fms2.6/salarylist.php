...
//$_SESSION['subid'] = $subid;
//$subid= $_SESSION['subid'];
$student=mysqli_query($conn,"SELECT * from salary where Year=$YEAR and StuId in ( select StuId from student where SId='$sid' and SubId='$subid') ");
    ...
    <div class="col-sm-5">
        <div class="user-area dropdown float-right">
            ...
            <div class="user-menu dropdown-menu">
                ...
                <a class="nav-link" id="logoutbut" href="logout.php"><i class="fa fa-power-off"></i> Logout</a>
            </div>
        </div>
    </div>
                ...
                <div class="content mt-3">
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-4 animated fadeInUp">                        
                        ...
                        <div class="dropdownmonthslr">
                            <ul>
                                ...
                                <ul class="liul2" onchange="test()" id='year'>
                                    <li><a href="chooseyear.php?year=2019&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">2019</a></li>
                                    <li><a href="chooseyear.php?year=2020&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">2020</a></li>
                                    <li><a href="chooseyear.php?year=2021&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">2021</a></li>
                        ...
                        <div class="dropdownmonthslr">
                            <ul>
                                <li class="chosemonthforslr1">Choose Month <i class="fa fa-angle-down"></i></li>
                                <ul class="liul1">
                                    <li><a href="choosemonth.php?month=January&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>" style="color: white;">January</a></li>
                                    <li><a href="choosemonth.php?month=February&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">February</a></li>
                                    <li><a href="choosemonth.php?month=March&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">March</a></li>
                                    <li><a href="choosemonth.php?month=April&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">April</a></li>
                                    <li><a href="choosemonth.php?month=May&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">May</a></li>
                                    <li><a href="choosemonth.php?month=June&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">June</a></li>
                                    <li><a href="choosemonth.php?month=July&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">July</a></li>
                                    <li><a href="choosemonth.php?month=August&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">August</a></li>
                                    <li><a href="choosemonth.php?month=September&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">September</a></li>
                                    <li><a href="choosemonth.php?month=October&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">October</a></li>
                                    <li><a href="choosemonth.php?month=November&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">November</a></li>
                                    <li><a href="choosemonth.php?month=December&sid=<?php echo $sid ?>&subid=<?php echo $subid ?>"  style="color: white;">December</a></li>                                    
                                </ul>
                            </ul>
                        </div>
